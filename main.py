...
st.markdown("<h1 style='text-align: center; color: #008000;'> 🏡 Welcome To AgroTechHub</h1>", unsafe_allow_html=True)
st.markdown("""
...
st.image("Graphics/Landing.jpeg", use_column_width=True)  # Add an image to make it visually appealing
